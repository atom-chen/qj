...
function MJScene:setMjSpecialData()
    ...
    self.curLuaFile = 'scene.HBTDHMJScene'

    self.mjTypeWanFa = 'hbtdhmj'

    self.mjGameName = '河北推倒胡'

    self.deskName3d = 'ui/qj_bg/3d/3d_hbtdh.png'
    self.deskName = 'ui/qj_bg/2d/2d_hbtdh.png'

    self.RecordGameType = RecordGameType.HBTDH
end

function MJScene:loadMjLogic()
    self.MJLogic = require('logic.mjhbtdh_logic')
end
